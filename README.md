...
Ничего из обязательного по ТЗ. Дополнительно в рамках выделенного времени реализованы продуктовые инициативы (scatter plot, CSV-экспорт, сглаживание) и инженерные практики (тесты, CI).
...
| Тесты (backend + frontend) + CI | 1 ч |
| Scatter plot, CSV, сглаживание | 1 ч |
| Отладка (DateTime, Recharts, Vite proxy) | 1 ч |
| Docker Compose + nginx | 30 мин |
| Документация и скриншоты | 30 мин |
| **Итого** | **~8 ч** |
